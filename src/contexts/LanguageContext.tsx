...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    // VIP Tourism
    'nav.vipTourism': 'VIP السياحة العلاجية',
    'vip.hero.badge': 'خدمة VIP',
    'vip.hero.title': 'VIP السياحة العلاجية في جمهورية بيلاروسيا',
    'vip.hero.description': 'السياحة العلاجية VIP هي تنظيم شخصي للتشخيص والعلاج وإقامة المريض في جمهورية بيلاروسيا مع مستوى عالٍ من الراحة والسرية والخدمة ذات الأولوية.',
    
    'vip.target.title': 'الموجه للمفهوم',
    'vip.target.subtitle': 'النموذج موجه إلى:',
    'vip.target.quality': 'المرضى ذوي المتطلبات العالية للجودة والخصوصية',
    'vip.target.hnwi': 'عملاء VIP و HNWI',
    'vip.target.cultural': 'المرضى من دول الشرق الأوسط ومناطق أخرى الذين يقدرون التكيف الثقافي والمرافقة الشخصية',
    
    'vip.principles.title': 'المبادئ الرئيسية لنظام VIP',
    'vip.principles.coordinator.title': 'نافذة واحدة',
    'vip.principles.coordinator.desc': 'منسق شخصي واحد 24/7',
    'vip.principles.priority.title': 'الأولوية',
    'vip.principles.priority.desc': 'فحوصات ودخول مستشفى سريعة',
    'vip.principles.confidentiality.title': 'السرية',
    'vip.principles.confidentiality.desc': 'اتفاقية عدم الإفصاح، قنوات اتصال مغلقة',
    'vip.principles.comfort.title': 'الراحة',
    'vip.principles.comfort.desc': 'غرف مميزة، لوجستيات فردية',
    'vip.principles.cultural.title': 'التكيف الثقافي',
    'vip.principles.cultural.desc': 'الخصائص الدينية والمعيشية',
    'vip.principles.security.title': 'الأمان',
    'vip.principles.security.desc': 'مسارات وخدمات موثوقة',
    
    'vip.structure.title': 'هيكل خدمة VIP',
    'vip.structure.stage1.title': 'المرحلة 1. التحضير المسبق',
    'vip.structure.stage1.docs': 'تحليل المستندات الطبية (RU / EN / AR)',
    'vip.structure.stage1.route': 'تشكيل مسار طبي فردي',
    'vip.structure.stage1.doctor': 'اختيار الطبيب الرائد والعيادة المتخصصة',
    'vip.structure.stage1.estimate': 'تقدير أولي وجدول العلاج',
    'vip.structure.stage1.visa': 'التحضير للتأشيرة واللوجستيات (عند الحاجة)',
    
    'vip.structure.stage2.title': 'المرحلة 2. الكتلة الطبية (ذات الأولوية)',
    'vip.structure.stage2.diagnostics': 'تشخيص سريع (فحص شامل خلال 24-72 ساعة)',
    'vip.structure.stage2.hospitalization': 'دخول مستشفى ذو أولوية',
    'vip.structure.stage2.doctor': 'طبيب معالج شخصي',
    'vip.structure.stage2.consilium': 'استشارات بدون انتظار',
    'vip.structure.stage2.surgery': 'فترات جراحية منفصلة (حسب الحاجة)',
    'vip.structure.stage2.translator': 'مرافقة مترجم (عند الحاجة)',
    'vip.structure.stage2.note': 'يتم تقديم الخدمات الطبية مباشرة من قبل العيادات. حزمة VIP لا تؤثر على القرارات الطبية، لكنها تؤثر على السرعة والراحة والوصول.',
    
    'vip.structure.stage3.title': 'المرحلة 3. الخدمة والراحة',
    'vip.structure.stage3.transfer': 'نقل VIP (المطار - العيادة - الإقامة)',
    'vip.structure.stage3.accommodation.title': 'الإقامة:',
    'vip.structure.stage3.accommodation.hotel': 'فندق 4-5 نجوم / شقق',
    'vip.structure.stage3.accommodation.sanatorium': 'مصحة فاخرة (إعادة التأهيل)',
    'vip.structure.stage3.food.title': 'الطعام:',
    'vip.structure.stage3.food.menu': 'قائمة طعام فردية',
    'vip.structure.stage3.food.halal': 'خيارات حلال (بناءً على الطلب)',
    'vip.structure.stage3.assistant': 'مساعد / منسق شخصي',
    
    'vip.structure.stage4.title': 'المرحلة 4. البرنامج الثقافي والعائلي',
    'vip.structure.stage4.excursions': 'جولات فردية (بدون مجموعات)',
    'vip.structure.stage4.family': 'مرافقة أفراد الأسرة',
    'vip.structure.stage4.spa': 'برامج سبا / عافية (إذا كان مسموحًا)',
    'vip.structure.stage4.religious': 'بنية تحتية دينية (بناءً على الطلب)',
    
    'vip.packages.title': 'باقات VIP والأسعار الإرشادية',
    'vip.packages.price': 'تكلفة خدمة VIP:',
    'vip.packages.popular': 'الأكثر شعبية',
    
    'vip.packages.silver.title': 'VIP SILVER',
    'vip.packages.silver.subtitle': 'للمرضى الذين يخضعون للتشخيص أو العلاج القصير',
    'vip.packages.silver.coordinator': 'منسق شخصي',
    'vip.packages.silver.priority': 'حجوزات ذات أولوية',
    'vip.packages.silver.translation': 'ترجمة ومرافقة',
    'vip.packages.silver.transfer': 'النقل',
    'vip.packages.silver.accommodation': 'إقامة 4 نجوم (7 أيام)',
    'vip.packages.silver.price': 'من 3,500 دولار',
    
    'vip.packages.gold.title': 'VIP GOLD',
    'vip.packages.gold.subtitle': 'للمرضى الذين يخضعون للعلاج الجراحي',
    'vip.packages.gold.route': 'مسار طبي موسع',
    'vip.packages.gold.hospitalization': 'دخول مستشفى ذو أولوية',
    'vip.packages.gold.room': 'غرفة مريحة مميزة',
    'vip.packages.gold.coordinator': 'منسق 24/7',
    'vip.packages.gold.accommodation': 'إقامة 5 نجوم / شقق فاخرة',
    'vip.packages.gold.family': 'مرافقة الأسرة',
    'vip.packages.gold.price': 'من 5,000 إلى 8,000 دولار',
    
    'vip.packages.platinum.title': 'VIP PLATINUM',
    'vip.packages.platinum.subtitle': 'للحالات المعقدة، HNWI، المرضى السريين',
    'vip.packages.platinum.curator': 'أمين طبي شخصي',
    'vip.packages.platinum.consultations': 'استشارات مغلقة',
    'vip.packages.platinum.priority': 'أقصى أولوية في العيادة',
    'vip.packages.platinum.logistics': 'لوجستيات خاصة',
    'vip.packages.platinum.confidentiality': 'سرية معززة',
    'vip.packages.platinum.cultural': 'برنامج ثقافي فردي',
    'vip.packages.platinum.extended': 'رعاية ممتدة بعد الخروج',
    'vip.packages.platinum.price': 'من 10,000 إلى 20,000 دولار',
    
    'vip.excluded.title': 'ما لا يشمله باقات VIP',
    'vip.excluded.medical': 'تكلفة الخدمات الطبية للعيادات',
    'vip.excluded.implants': 'تكلفة الغرسات والأدوية والمواد المتبرع بها',
    'vip.excluded.emergency': 'التدخلات الطبية الطارئة خارج الخطة المتفق عليها',
    
    'vip.payment.title': 'إجراء دفع خدمة VIP',
    'vip.payment.prepayment': 'الدفعة المقدمة: 50-100% من تكلفة خدمة VIP',
    'vip.payment.medical': 'يتم دفع الخدمات الطبية بشكل منفصل ومباشرة للعيادات',
    'vip.payment.partner': 'الدفع ممكن عبر الشركة الشريكة بالاتفاق',
    'vip.payment.documents': 'يتم تقديم جميع المستندات المؤيدة',
    
    'vip.legal.title': 'مهم قانونياً',
    'vip.legal.notMedical': 'منسق VIP ليس منظمة طبية',
    'vip.legal.noInfluence': 'لا يؤثر على القرارات الطبية',
    'vip.legal.noResponsibility': 'لا يتحمل المسؤولية عن نتيجة العلاج',
    'vip.legal.organizer': 'يعمل كمنظم ومزود خدمة',
  ...
  ru: {
    ...
    // VIP Tourism
    'nav.vipTourism': 'VIP-туризм',
    'vip.hero.badge': 'VIP-сервис',
    'vip.hero.title': 'VIP-медицинский туризм в Республике Беларусь',
    'vip.hero.description': 'VIP-медицинский туризм — это персонализированная организация диагностики, лечения и пребывания пациента в Республике Беларусь с повышенным уровнем комфорта, конфиденциальности и приоритетного сервиса.',
    
    'vip.target.title': 'Концепция VIP-обслуживания',
    'vip.target.subtitle': 'Модель ориентирована на:',
    'vip.target.quality': 'Пациентов с высоким запросом к качеству и приватности',
    'vip.target.hnwi': 'VIP- и HNWI-клиентов',
    'vip.target.cultural': 'Пациентов из стран Ближнего Востока и других регионов, ценящих культурную адаптацию и персональное сопровождение',
    
    'vip.principles.title': 'Ключевые принципы VIP-формата',
    'vip.principles.coordinator.title': 'Единое окно',
    'vip.principles.coordinator.desc': 'Один персональный координатор 24/7',
    'vip.principles.priority.title': 'Приоритет',
    'vip.principles.priority.desc': 'Ускоренные обследования и госпитализация',
    'vip.principles.confidentiality.title': 'Конфиденциальность',
    'vip.principles.confidentiality.desc': 'NDA, закрытые каналы коммуникации',
    'vip.principles.comfort.title': 'Комфорт',
    'vip.principles.comfort.desc': 'Палаты повышенного уровня, индивидуальная логистика',
    'vip.principles.cultural.title': 'Культурная адаптация',
    'vip.principles.cultural.desc': 'Религиозные и бытовые особенности',
    'vip.principles.security.title': 'Безопасность',
    'vip.principles.security.desc': 'Проверенные маршруты и сервисы',
    
    'vip.structure.title': 'Структура VIP-обслуживания',
    'vip.structure.stage1.title': 'Этап 1. Предварительная подготовка',
    'vip.structure.stage1.docs': 'Анализ медицинских документов (RU / EN / AR)',
    'vip.structure.stage1.route': 'Формирование индивидуального медицинского маршрута',
    'vip.structure.stage1.doctor': 'Подбор ведущего врача и профильной клиники',
    'vip.structure.stage1.estimate': 'Предварительная смета и график лечения',
    'vip.structure.stage1.visa': 'Визовая и логистическая подготовка (при необходимости)',
    
    'vip.structure.stage2.title': 'Этап 2. Медицинский блок (приоритетный)',
    'vip.structure.stage2.diagnostics': 'Ускоренное прохождение диагностики (check-up за 24–72 часа)',
    'vip.structure.stage2.hospitalization': 'Приоритетная госпитализация',
    'vip.structure.stage2.doctor': 'Персональный лечащий врач',
    'vip.structure.stage2.consilium': 'Консилиумы без ожидания',
    'vip.structure.stage2.surgery': 'Отдельные операционные окна (по показаниям)',
    'vip.structure.stage2.translator': 'Сопровождение переводчика (при необходимости)',
    'vip.structure.stage2.note': 'Медицинские услуги оказываются непосредственно Клиниками. VIP-пакет не влияет на медицинские решения, но влияет на скорость, комфорт и доступ.',
    
    'vip.structure.stage3.title': 'Этап 3. Сервис и комфорт',
    'vip.structure.stage3.transfer': 'VIP-трансфер (аэропорт — клиника — резиденция)',
    'vip.structure.stage3.accommodation.title': 'Проживание:',
    'vip.structure.stage3.accommodation.hotel': 'Premium-отель 4–5★ / апартаменты',
    'vip.structure.stage3.accommodation.sanatorium': 'Санаторий premium-класса (реабилитация)',
    'vip.structure.stage3.food.title': 'Питание:',
    'vip.structure.stage3.food.menu': 'Индивидуальное меню',
    'vip.structure.stage3.food.halal': 'Халяль-опции (по запросу)',
    'vip.structure.stage3.assistant': 'Личный ассистент / координатор',
    
    'vip.structure.stage4.title': 'Этап 4. Культурная и семейная программа',
    'vip.structure.stage4.excursions': 'Индивидуальные экскурсии (без групп)',
    'vip.structure.stage4.family': 'Сопровождение членов семьи',
    'vip.structure.stage4.spa': 'SPA / wellness-программы (если допустимо)',
    'vip.structure.stage4.religious': 'Религиозная инфраструктура (по запросу)',
    
    'vip.packages.title': 'VIP-пакеты и ориентировочные цены',
    'vip.packages.price': 'Стоимость VIP-сервиса:',
    'vip.packages.popular': 'Популярный',
    
    'vip.packages.silver.title': 'VIP SILVER',
    'vip.packages.silver.subtitle': 'Для пациентов с диагностикой или кратким лечением',
    'vip.packages.silver.coordinator': 'Персональный координатор',
    'vip.packages.silver.priority': 'Приоритетные записи',
    'vip.packages.silver.translation': 'Перевод и сопровождение',
    'vip.packages.silver.transfer': 'Трансферы',
    'vip.packages.silver.accommodation': 'Проживание 4★ (7 дней)',
    'vip.packages.silver.price': 'от 3 500 USD',
    
    'vip.packages.gold.title': 'VIP GOLD',
    'vip.packages.gold.subtitle': 'Для пациентов с хирургическим лечением',
    'vip.packages.gold.route': 'Расширенный медицинский маршрут',
    'vip.packages.gold.hospitalization': 'Приоритетная госпитализация',
    'vip.packages.gold.room': 'Палата повышенного комфорта',
    'vip.packages.gold.coordinator': 'Координатор 24/7',
    'vip.packages.gold.accommodation': 'Проживание 5★ / premium-апартаменты',
    'vip.packages.gold.family': 'Сопровождение семьи',
    'vip.packages.gold.price': 'от 5 000 до 8 000 USD',
    
    'vip.packages.platinum.title': 'VIP PLATINUM',
    'vip.packages.platinum.subtitle': 'Для сложных случаев, HNWI, конфиденциальных пациентов',
    'vip.packages.platinum.curator': 'Персональный медицинский куратор',
    'vip.packages.platinum.consultations': 'Закрытые консультации',
    'vip.packages.platinum.priority': 'Максимальный приоритет в клинике',
    'vip.packages.platinum.logistics': 'Private-логистика',
    'vip.packages.platinum.confidentiality': 'Усиленная конфиденциальность',
    'vip.packages.platinum.cultural': 'Индивидуальная культурная программа',
    'vip.packages.platinum.extended': 'Extended-care после выписки',
    'vip.packages.platinum.price': 'от 10 000 до 20 000 USD',
    
    'vip.excluded.title': 'Что НЕ входит в VIP-пакеты',
    'vip.excluded.medical': 'Стоимость медицинских услуг Клиник',
    'vip.excluded.implants': 'Стоимость имплантов, препаратов, донорских материалов',
    'vip.excluded.emergency': 'Экстренные медицинские вмешательства вне согласованного плана',
    
    'vip.payment.title': 'Порядок оплаты VIP-обслуживания',
    'vip.payment.prepayment': 'Предоплата: 50–100% стоимости VIP-сервиса',
    'vip.payment.medical': 'Медицинские услуги оплачиваются отдельно и напрямую Клиникам',
    'vip.payment.partner': 'Возможна оплата через компанию-партнёра по согласованию',
    'vip.payment.documents': 'Предоставляются все подтверждающие документы',
    
    'vip.legal.title': 'Юридически важное',
    'vip.legal.notMedical': 'VIP-координатор не является медицинской организацией',
    'vip.legal.noInfluence': 'Не влияет на медицинские решения',
    'vip.legal.noResponsibility': 'Не несёт ответственности за исход лечения',
    'vip.legal.organizer': 'Действует как организатор и сервис-провайдер',
  ...
  en: {
    ...
    // VIP Tourism
    'nav.vipTourism': 'VIP Tourism',
    'vip.hero.badge': 'VIP Service',
    'vip.hero.title': 'VIP Medical Tourism in the Republic of Belarus',
    'vip.hero.description': 'VIP medical tourism is a personalized organization of diagnostics, treatment, and patient stay in the Republic of Belarus with an enhanced level of comfort, confidentiality, and priority service.',
    
    'vip.target.title': 'VIP Service Concept',
    'vip.target.subtitle': 'The model is aimed at:',
    'vip.target.quality': 'Patients with high demands for quality and privacy',
    'vip.target.hnwi': 'VIP and HNWI clients',
    'vip.target.cultural': 'Patients from Middle Eastern countries and other regions who value cultural adaptation and personal accompaniment',
    
    'vip.principles.title': 'Key Principles of VIP Format',
    'vip.principles.coordinator.title': 'Single Window',
    'vip.principles.coordinator.desc': 'One personal coordinator 24/7',
    'vip.principles.priority.title': 'Priority',
    'vip.principles.priority.desc': 'Expedited examinations and hospitalization',
    'vip.principles.confidentiality.title': 'Confidentiality',
    'vip.principles.confidentiality.desc': 'NDA, closed communication channels',
    'vip.principles.comfort.title': 'Comfort',
    'vip.principles.comfort.desc': 'Premium rooms, individual logistics',
    'vip.principles.cultural.title': 'Cultural Adaptation',
    'vip.principles.cultural.desc': 'Religious and lifestyle features',
    'vip.principles.security.title': 'Security',
    'vip.principles.security.desc': 'Verified routes and services',
    
    'vip.structure.title': 'VIP Service Structure',
    'vip.structure.stage1.title': 'Stage 1. Preliminary Preparation',
    'vip.structure.stage1.docs': 'Analysis of medical documents (RU / EN / AR)',
    'vip.structure.stage1.route': 'Formation of individual medical route',
    'vip.structure.stage1.doctor': 'Selection of leading doctor and specialized clinic',
    'vip.structure.stage1.estimate': 'Preliminary estimate and treatment schedule',
    'vip.structure.stage1.visa': 'Visa and logistics preparation (if necessary)',
    
    'vip.structure.stage2.title': 'Stage 2. Medical Block (Priority)',
    'vip.structure.stage2.diagnostics': 'Expedited diagnostics (check-up in 24-72 hours)',
    'vip.structure.stage2.hospitalization': 'Priority hospitalization',
    'vip.structure.stage2.doctor': 'Personal attending physician',
    'vip.structure.stage2.consilium': 'Consultations without waiting',
    'vip.structure.stage2.surgery': 'Separate surgical windows (as indicated)',
    'vip.structure.stage2.translator': 'Interpreter accompaniment (if necessary)',
    'vip.structure.stage2.note': 'Medical services are provided directly by Clinics. VIP package does not affect medical decisions, but affects speed, comfort, and access.',
    
    'vip.structure.stage3.title': 'Stage 3. Service and Comfort',
    'vip.structure.stage3.transfer': 'VIP transfer (airport - clinic - residence)',
    'vip.structure.stage3.accommodation.title': 'Accommodation:',
    'vip.structure.stage3.accommodation.hotel': 'Premium hotel 4-5★ / apartments',
    'vip.structure.stage3.accommodation.sanatorium': 'Premium sanatorium (rehabilitation)',
    'vip.structure.stage3.food.title': 'Meals:',
    'vip.structure.stage3.food.menu': 'Individual menu',
    'vip.structure.stage3.food.halal': 'Halal options (on request)',
    'vip.structure.stage3.assistant': 'Personal assistant / coordinator',
    
    'vip.structure.stage4.title': 'Stage 4. Cultural and Family Program',
    'vip.structure.stage4.excursions': 'Individual excursions (no groups)',
    'vip.structure.stage4.family': 'Accompaniment of family members',
    'vip.structure.stage4.spa': 'SPA / wellness programs (if permitted)',
    'vip.structure.stage4.religious': 'Religious infrastructure (on request)',
    
    'vip.packages.title': 'VIP Packages and Indicative Prices',
    'vip.packages.price': 'VIP service cost:',
    'vip.packages.popular': 'Popular',
    
    'vip.packages.silver.title': 'VIP SILVER',
    'vip.packages.silver.subtitle': 'For patients with diagnostics or short treatment',
    'vip.packages.silver.coordinator': 'Personal coordinator',
    'vip.packages.silver.priority': 'Priority appointments',
    'vip.packages.silver.translation': 'Translation and accompaniment',
    'vip.packages.silver.transfer': 'Transfers',
    'vip.packages.silver.accommodation': '4★ accommodation (7 days)',
    'vip.packages.silver.price': 'from $3,500',
    
    'vip.packages.gold.title': 'VIP GOLD',
    'vip.packages.gold.subtitle': 'For patients with surgical treatment',
    'vip.packages.gold.route': 'Extended medical route',
    'vip.packages.gold.hospitalization': 'Priority hospitalization',
    'vip.packages.gold.room': 'Enhanced comfort room',
    'vip.packages.gold.coordinator': 'Coordinator 24/7',
    'vip.packages.gold.accommodation': '5★ accommodation / premium apartments',
    'vip.packages.gold.family': 'Family accompaniment',
    'vip.packages.gold.price': 'from $5,000 to $8,000',
    
    'vip.packages.platinum.title': 'VIP PLATINUM',
    'vip.packages.platinum.subtitle': 'For complex cases, HNWI, confidential patients',
    'vip.packages.platinum.curator': 'Personal medical curator',
    'vip.packages.platinum.consultations': 'Closed consultations',
    'vip.packages.platinum.priority': 'Maximum priority in clinic',
    'vip.packages.platinum.logistics': 'Private logistics',
    'vip.packages.platinum.confidentiality': 'Enhanced confidentiality',
    'vip.packages.platinum.cultural': 'Individual cultural program',
    'vip.packages.platinum.extended': 'Extended care after discharge',
    'vip.packages.platinum.price': 'from $10,000 to $20,000',
    
    'vip.excluded.title': 'What is NOT Included in VIP Packages',
    'vip.excluded.medical': 'Cost of medical services from Clinics',
    'vip.excluded.implants': 'Cost of implants, medications, donor materials',
    'vip.excluded.emergency': 'Emergency medical interventions outside the agreed plan',
    
    'vip.payment.title': 'VIP Service Payment Procedure',
    'vip.payment.prepayment': 'Prepayment: 50-100% of VIP service cost',
    'vip.payment.medical': 'Medical services are paid separately and directly to Clinics',
    'vip.payment.partner': 'Payment through partner company is possible by agreement',
    'vip.payment.documents': 'All supporting documents are provided',
    
    'vip.legal.title': 'Legally Important',
    'vip.legal.notMedical': 'VIP coordinator is not a medical organization',
    'vip.legal.noInfluence': 'Does not influence medical decisions',
    'vip.legal.noResponsibility': 'Does not bear responsibility for treatment outcome',
    'vip.legal.organizer': 'Acts as an organizer and service provider',
