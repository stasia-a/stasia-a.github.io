...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'prices.partner.item2': 'للتحويل اللاحق للأموال إلى المنفذ و/أو الأطراف الثالثة',
  ...
  ru: {
    ...
    'prices.partner.item2': 'Для последующего перечисления средств Исполнителю и/или третьим лицам',
  ...
  en: {
    ...
    'prices.partner.item2': 'For subsequent transfer of funds to the Contractor and/or third parties',
